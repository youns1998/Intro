            ...
            public void run() {
                ...
                for(int i=286 ; i<386 ; i++) {
                    try {
                        ...
                        builder_title.append(webTitle).append("\n"); //제목 저장
                        ...
                        builder_mainImage.append(mainImg).append("\n"); //src 문자열 저장
                        ...
                        builder_ingre.append(ingre).append("\n"); //재료텍스트 문자열 저장
                        ...
                        for (j = 1; j < 30; j++) {   // j = 요리순서index
                            ...
                            builder_steps.append(steps).append("\n"); //요리법 문자열 저장
                            ...
                            {
                                builder_stepsImage.append("no_image").append("\n");//src가 저장될 곳에 no_image 문자열 저장
                            } else                                                //만약 요리사진이 있다면?
                            {
                                builder_stepsImage.append(stepsImg).append("\n");        //src를 추가
